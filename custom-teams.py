            ...
            "attachments":[{
                ...
                "content":{
                    ...
                    "actions":[{"type":"Action.OpenUrl",
                                "title":"Dashboard",
                                "url":f"https://your.wazuh.dashboard.ip/app/threat-hunting#/overview/?tab=general&tabView=events&_a=(filters:!(),query:(language:kuery,query:''))&_g=(filters:!(),refreshInterval:(pause:!t,value:0),time:(from:now-24h,to:now))&agentId={agent.get('id','')}"}]
                }
            }]
        }
        return att
